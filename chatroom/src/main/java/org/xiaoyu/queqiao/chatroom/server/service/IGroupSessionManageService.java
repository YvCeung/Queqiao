 ...
 * 聊天组会话管理接口
 */
public interface IGroupSessionManageService {
     ...
     */
    ChatGroup joinMember(String name, String member);
     ...
     * @return 如果组不存在返回 null, 否则返回组对象
     */
    ChatGroup removeMember(String name, String member);
     ...
     * @return 如果组不存在返回 null, 否则返回组对象
     */
    ChatGroup removeGroup(String name);
